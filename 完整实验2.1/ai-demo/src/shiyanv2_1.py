...
"""erduier"""
class Fan_Fou_MC1(MahJong_NO_State_Base):
    '''
    二人麻将无状态AI，第一版本
    '''
    ...
    def del_ourself_drw(self, listen_list):
        ...
        try:
            ...
            for x in range(3):
                for j in range(2, 7):
                    if hand_array[x, j] == 1 and hand_array[x, j - 2] == 0 and hand_array[x, j - 1] == 0 and hand_array[
                        x, j + 1] == 0 and hand_array[x, j + 2] == 0:
            ...
            for j in range(3):
                ...
                if hand_array[j, 0] == 1 and hand_array[j, 1] != 0 and hand_array[j, 2] == 0 and hand_array[j, 3] == 1:
                    hand_array_else_second.append([j, 0])
                # 123400
                if hand_array[j, 0] == 1 and hand_array[j, 1] == 1 and hand_array[j, 2] == 1 and hand_array[
                    j, 3] == 1 and hand_array[j, 4] == 0 and hand_array[j, 5] == 0:
                    hand_array_else_second.append([j, 0])
                # 987600
                if hand_array[j, 8] == 1 and hand_array[j, 7] == 1 and hand_array[j, 6] == 1 and hand_array[
                    j, 5] == 1 and hand_array[j, 4] == 0 and hand_array[j, 3] == 0:
                    hand_array_else_second.append([j, 8])

                # 103,120
                if (hand_array[j, 0] == 1 and hand_array[j, 1] == 0 and hand_array[j, 2] == 1) or (
                        hand_array[j, 0] == 1 and hand_array[j, 1] == 1 and hand_array[j, 2] == 0):
                    hand_array_else_second.append([j, 0])
                # 907,980
                if (hand_array[j, 8] == 1 and hand_array[j, 7] == 0 and hand_array[j, 6] == 1) or (
                        hand_array[j, 8] == 1 and hand_array[j, 7] == 1 and hand_array[j, 6] == 0):
                    hand_array_else_second.append([j, 8])

            for i in range(3):
                if len(hand_array_cupple) > 1:
                    #  1223和7889打2和8
                    if hand_array[i, 0] == 1 and hand_array[i, 1] == 2 and hand_array[i, 2] == 1 and hand_array[
                        i, 3] == 0:
                        hand_array_else_second.append([i, 1])
                    if hand_array[i, 8] == 1 and hand_array[i, 7] == 2 and hand_array[i, 6] == 1 and hand_array[
                        i, 5] == 0:
                        hand_array_else_second.append([i, 7])

            for i in range(3):
                # (1) 2450,24450or2455
                if (hand_array[i, 1] == 1 and hand_array[i, 2] == 0 and hand_array[i, 3] != 0 and hand_array[
                    i, 4] == 1 and hand_array[i, 0] != 1) or (
                        hand_array[i, 1] == 1 and hand_array[i, 2] == 0 and hand_array[i, 3] == 1 and hand_array[
                    i, 4] != 0 and hand_array[i, 0] != 1):
                    hand_array_else_second.append([i, 1])
                # 5680,56680,55680 (1)
                if (hand_array[i, 7] == 1 and hand_array[i, 6] == 0 and hand_array[i, 5] != 0 and hand_array[
                    i, 4] == 1 and hand_array[i, 8] != 1) or (
                        hand_array[i, 7] == 1 and hand_array[i, 6] == 0 and hand_array[i, 5] == 1 and hand_array[
                    i, 4] != 0 and hand_array[i, 8] != 1):
                    hand_array_else_second.append([i, 7])
            for i in range(3):
                # 00356,3556,3566(1)-00578,5778,5788(1)
                for j in range(2, 5):
                    if (hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] != 0 and
                        hand_array[i, j + 3] == 1 and hand_array[i, j + 4] != 1 and hand_array[i, j - 1] == 0 and
                        hand_array[i, j - 2] == 0) or (
                            hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 1 and
                            hand_array[i, j + 3] != 0 and hand_array[i, j + 4] != 1 and hand_array[i, j - 1] == 0 and
                            hand_array[i, j - 2] == 0):
                        hand_array_else_second.append([i, j])
                # (1)235,2335,223500-(1)457,4557,445700
                for j in range(4, 7):
                    if (hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 0 and
                        hand_array[i, j - 1] == 0 and hand_array[i, j - 2] != 0 and hand_array[i, j - 3] == 1 and
                        hand_array[i, j - 4] != 1) or (
                            hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 0 and
                            hand_array[i, j - 1] == 0 and hand_array[i, j - 2] == 1 and hand_array[i, j - 3] != 0 and
                            hand_array[i, j - 4] != 1):
                        hand_array_else_second.append([i, j])
            ...
            for j in range(3):
                if hand_array[j, 1] == 2 and hand_array[j, 0] == 1 and hand_array[j, 2] == 0:
                    hand_array_else_second.append([j, 0])
                if hand_array[j, 0] == 1 and hand_array[j, 1] == 2 and hand_array[j, 2] == 1 and hand_array[
                    j, 3] == 1 and hand_array[j, 4] == 1:
                    hand_array_else_second.append([j, 0])
                ...
                if hand_array[j, 7] == 2 and hand_array[j, 8] == 1 and hand_array[j, 6] == 0:
                    hand_array_else_second.append([j, 8])
                if hand_array[j, 8] == 1 and hand_array[j, 7] == 2 and hand_array[j, 6] == 1 and hand_array[
                    j, 5] == 1 and hand_array[j, 4] == 1:
                    hand_array_else_second.append([j, 8])
                # 779,6689
            ...
            for i in range(3):
                # 003444-008999
                for j in range(2, 8):
                    if hand_array[i, j] == 1 and hand_array[i, j + 1] == 3 and hand_array[i, j - 1] == 0 and hand_array[
                        i, j - 2] == 0:
                        hand_array_else_second.append([i, j])
                # 111200-666700
                for j in range(1, 7):
                ...
                # 020444-070999
                for j in range(1, 7):
                    if hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 3 and hand_array[
                        i, j - 1] == 0:
                        hand_array_else_second.append([i, j])
                # 111030-666080
                for j in range(2, 8):
            ...
            for i in range(3):
                # 2456(0/2)-4678(0/2)
                for j in range(1, 4):
                    if hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 1 and hand_array[
                        i, j + 3] == 1 and hand_array[i, j + 4] == 1 and hand_array[i, j + 5] != 1:
                        hand_array_else_second.append([i, j])
                # 8654(0/2)-6432(0/2)
            ...
            for i in range(3):
                # 005789or123500
                if (hand_array[i, 4] == 1 and hand_array[i, 5] == 0 and hand_array[i, 6] == 1 and hand_array[
                    i, 7] == 1 and hand_array[i, 8] == 1 and hand_array[i, 3] == 0 and hand_array[i, 2] == 0) or (
                        hand_array[i, 4] == 1 and hand_array[i, 3] == 0 and hand_array[i, 2] == 1 and hand_array[
                    i, 1] == 1 and hand_array[i, 0] == 1 and hand_array[i, 5] == 0 and hand_array[i, 6] == 0):
            ...
            for i in range(3):
                ...
                for j in range(2, 5):
                    if (hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] != 0 and
                        hand_array[i, j + 3] == 1 and hand_array[i, j - 1] == 0 and hand_array[i, j - 2] == 0) or (
                            hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 1 and
                            hand_array[i, j + 3] != 0 and hand_array[i, j - 1] == 0 and hand_array[i, j - 2] == 0):
                        hand_array_else_second.append([i, j])
                # 235,2335,223500-457,4557,445700
                for j in range(4, 7):
                    if (hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 0 and
                        hand_array[i, j - 1] == 0 and hand_array[i, j - 2] != 0 and hand_array[i, j - 3] == 1) or (
                            hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 0 and
                            hand_array[i, j - 1] == 0 and hand_array[i, j - 2] == 1 and hand_array[i, j - 3] != 0):
                        hand_array_else_second.append([i, j])
            ...
            for i in range(3):
                ...
                for j in range(2, 7):
                    if hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 1 and hand_array[
                        i, j - 1] == 0 and hand_array[i, j - 2] != 2:
                        hand_array_else_second.append([i, j])
                # (2)0705-(2)0402
                for j in range(6, 3, -1):
                    if hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] != 2 and hand_array[
                        i, j - 1] == 0 and hand_array[i, j - 2] == 1:
                        hand_array_else_second.append([i, j])
            ...
            for x in range(3):
                for j in range(2, 7):
                    if (hand_array[x, j] == 1 and hand_array[x, j + 1] == 0 and hand_array[x, j + 2] == 0 and
                        hand_array[x, j - 1] == 0) or (
                            hand_array[x, j] == 1 and hand_array[x, j - 1] == 0 and hand_array[x, j - 2] == 0 and
                            hand_array[x, j + 1] == 0):
            ...
            for i in range(3):
                ...
                for j in range(3, 7):
                    if (hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 2 and
                        hand_array[i, j - 1] == 0) or (
                            hand_array[i, j] == 1 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 2 and
                            hand_array[i, j - 1] == 1 and hand_array[i, j - 2] == 1 and hand_array[i, j - 3] == 1):
                        hand_array_else_third.append([i, j])
                # 1130-4460or113456-446789
                for j in range(0, 4):
                    if (hand_array[i, j] == 2 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 1 and
                        hand_array[i, j + 3] == 0) or (
                            hand_array[i, j] == 2 and hand_array[i, j + 1] == 0 and hand_array[i, j + 2] == 1 and
                            hand_array[i, j + 3] == 1 and hand_array[i, j + 4] == 1 and hand_array[i, j + 5] == 1):
            ...
            for i in range(3):
                # 0678899 067880
                if hand_array[i, 8] != 1 and hand_array[i, 7] == 2 and hand_array[i, 6] == 1 and hand_array[
                    i, 5] == 1 and hand_array[i, 4] == 0:
                    hand_array_else_third.append([i, 7])
                # 123300-567700
                for j in range(0, 5):
                    if hand_array[i, j] == 1 and hand_array[i, j + 1] == 1 and hand_array[i, j + 2] == 2 and hand_array[
                        i, j + 3] == 0 and hand_array[i, j + 4] != 1:
                        hand_array_else_third.append([i, j + 2])
                # 007789-003345
                for j in range(2, 7):
                    if hand_array[i, j] == 2 and hand_array[i, j + 1] == 1 and hand_array[i, j + 2] == 1 and hand_array[
                        i, j - 1] == 0 and hand_array[i, j - 2] != 1:
                        hand_array_else_third.append([i, j])
                # 023340-067780
                for j in range(2, 7):
                    if hand_array[i, j] == 2 and hand_array[i, j + 1] == 1 and hand_array[i, j + 2] == 0 and hand_array[
                        i, j - 1] == 1 and hand_array[i, j - 2] == 0:
                        hand_array_else_third.append([i, j])
            ...
            for i in range(3):
                ...
                for j in range(2, 7):
                    if (hand_array[i, j] == 1 and hand_array[i, j + 1] == 2 and hand_array[i, j + 2] == 0) or (
                            hand_array[i, j] == 1 and hand_array[i, j - 1] == 2 and hand_array[i, j - 2] == 0):
                        hand_array_else_last.append([i, j])
            ...
            if len(hand_array_cupple) > 1:
                ...
                for i in range(3):
                    for j in range(2, 7):
                        if (hand_array[i][j] == 2 and hand_array[i][j + 1] == 2) or (
                                hand_array[i][j] == 2 and hand_array[i][j + 2] == 2) or (
                                hand_array[i][j] == 2 and hand_array[i][j - 1] == 2) or (
                                hand_array[i][j] == 2 and hand_array[i][j - 2] == 2):
                ...
                for i in range(3):
                    for j in range(1, 7):
                        if (hand_array[i][j] == 1 and hand_array[i][j + 1] == 1 and hand_array[i][j - 1] == 0 and
                            hand_array[i][j + 2] == 0 and discard_history[i][j - 1] > 0) or (
                                hand_array[i][j] == 1 and hand_array[i][j + 1] == 1 and hand_array[i][j - 1] == 0 and
                                hand_array[i][j + 2] == 0 and discard_history[i][j + 2] > 0):
                ...
                for i in range(3):
                    for j in range(1, 7):
                        if (hand_array[i][j] == 1 and hand_array[i][j + 1] == 1 and discard_history[i][j - 1] > 0) or (
                                hand_array[i][j] == 1 and hand_array[i][j + 1] == 1 and discard_history[i][j + 2] > 0):
                ...
                if hand_special_lian_one == [] and hand_special_lian_two == [] and hand_special_lian_three == []:
                    for x in range(len(self.majiang)):
            ...
            def pair_chai(self):
                if hand_special_cupple_one != []:
                    for i in range(len(hand_special_cupple_one)):
                        ...
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_cupple_one[i][0],
                                                                          hand_special_cupple_one[i][1]), '')
                    ...
                    for i in range(len(hand_special_cupple_two)):
                        ...
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_cupple_two[i][0],
                                                                          hand_special_cupple_two[i][1]), '')
                    ...
                    for i in range(len(hand_special_cupple_three)):
                        ...
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_cupple_three[i][0],
                                                                          hand_special_cupple_three[i][1]), '')
                    ...
                    for i in range(len(hand_special_lian_one)):
                        ...
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_lian_one[0][0],
                                                                          hand_special_lian_one[0][1]), '')
                    ...
                    for i in range(len(hand_special_lian_two)):
                        ...
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_lian_two[0][0],
                                                                          hand_special_lian_two[0][1]), '')
                    ...
                    for i in range(len(hand_special_lian_three)):
                        ...
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_lian_three[0][0],
                                                                          hand_special_lian_three[0][1]), '')
            ...
            times_third = []
            times_last = []
            times_special_cupple_one = []
            times_special_cupple_two = []
            times_special_cupple_three = []
            times_special_lian_one = []
            times_special_lian_two = []
            times_special_lian_three = []
            if can_ting:
                ...
                #     self._conv_req_mess('Discard', self._get_card_str(hand_array_else_sum[min_index][0],
                #                                                       hand_array_else_sum[min_index][1]), '')
                #     put = self._discard_hou(hand_array_else_sum[min_index][0], hand_array_else_sum[min_index][1])
                #     return put
                else:
                    if hand_special_cupple_one != []:
                        times_special_cupple_one = self._fire_hu(hand_special_cupple_one, listener_id)
                    if hand_special_cupple_two != []:
                        times_special_cupple_two = self._fire_hu(hand_special_cupple_two, listener_id)
                    if hand_special_cupple_three != []:
                        times_special_cupple_three = self._fire_hu(hand_special_cupple_three, listener_id)
                    if hand_special_lian_one != []:
                        times_special_lian_one = self._fire_hu(hand_special_lian_one, listener_id)
                    if hand_special_lian_two != []:
                        times_special_lian_two = self._fire_hu(hand_special_lian_two, listener_id)
                    if hand_special_lian_three != []:
                        times_special_lian_three = self._fire_hu(hand_special_lian_three, listener_id)
                    hand_special_sum = hand_special_cupple_one + hand_special_cupple_two + hand_special_cupple_three + hand_special_lian_one + hand_special_lian_two + hand_special_lian_three
                    if hand_special_sum != []:
                        times_special_sum = times_special_cupple_one + times_special_cupple_two + times_special_cupple_three + times_special_lian_one + times_special_lian_two + times_special_lian_three
                        min_index = times_special_sum.index(min(times_special_sum))
                        print("teshupai选择点炮次数最少的打(%d,%d)" % (
                        hand_special_sum[min_index][0], hand_special_sum[min_index][1]))
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_sum[min_index][0],
                                                                          hand_special_sum[min_index][1]), '')
                        put = self._discard_hou(hand_special_sum[min_index][0], hand_special_sum[min_index][1])
                        return put
            else:
                if hand_array_else_first != []:
                    ...
                    #         self._conv_req_mess('Discard', self._get_card_str(hand_array_else_first[i][0],
                    #                                                           hand_array_else_first[i][1]), '')
                    ...
                    self._conv_req_mess('Discard',
                                        self._get_card_str(hand_array_else_first[0][0], hand_array_else_first[0][1]),
                                        '')
                    ...
                    #         self._conv_req_mess('Discard', self._get_card_str(hand_array_else_second[i][0],
                    #                                                           hand_array_else_second[i][1]), '')
                    ...
                    self._conv_req_mess('Discard',
                                        self._get_card_str(hand_array_else_second[0][0], hand_array_else_second[0][1]),
                                        '')
                    ...
                    #         self._conv_req_mess('Discard', self._get_card_str(hand_array_else_third[i][0],
                    #                                                           hand_array_else_third[i][1]), '')
                    ...
                    self._conv_req_mess('Discard',
                                        self._get_card_str(hand_array_else_third[0][0], hand_array_else_third[0][1]),
                                        '')
                    ...
                    #         self._conv_req_mess('Discard', self._get_card_str(hand_array_else_last[i][0],
                    #                                                           hand_array_else_last[i][1]), '')
                    ...
                    self._conv_req_mess('Discard',
                                        self._get_card_str(hand_array_else_last[0][0], hand_array_else_last[0][1]), '')
                    put = self._discard_hou(hand_array_else_last[0][0], hand_array_else_last[0][1])
                    return put
                else:
                    # 四个优先级弃牌为空时弃牌考虑 吃牌为空寻求碰碰胡 不为空拆对子
                    if chow_hand_card != "":
                        print('fan_fou_mc chow_hand_card != ""的情况', chow_hand_card)
                        put = pair_chai(self)
                        return put
                        """
                    ...
                    # 寻求对对胡
                        ...
                        # 普通胡
                            ...
                            print('fan_fou_mc chow_hand_card == ""并且碰杠三张个数小于4的情况')
                            put = pair_chai(self)
                            return put
...
class Fan_Fou_MC2(MahJong_NO_State_Base):
    '''
    二人麻将无状态AI，第一版本
    '''
    def __init__(self, seat, majiang):
    ...
    def del_ourself_drw(self, listen_list):
        ...
        try:
            ...
            if len(hand_array_cupple)>1:
                ...
                for i in range(3):
                    for j in range(1,7):
                        if (hand_array[i][j]==1 and hand_array[i][j+1]==1 and discard_history[i][j-1]>0) or (hand_array[i][j]==1 and hand_array[i][j+1]==1 and discard_history[i][j+2]>0):
                            hand_special_lian_two.append([i,j])
                print('Fan_fou_mc special_lian_two连牌拆没有打出去的牌',hand_special_lian_two)
                for i in range(3):
                    for j in range(0, 9):
            ...
            if can_ting:
                ...
                #     return put
                    ...
                    if hand_special_sum != []:
                        times_special_sum = times_special_cupple_one + times_special_cupple_two + times_special_cupple_three + times_special_lian_one + times_special_lian_two + times_special_lian_three
                        min_index = times_special_sum.index(min(times_special_sum))
                        print("teshupai选择点炮次数最少的打(%d,%d)" %(hand_special_sum[min_index][0], hand_special_sum[min_index][1]))
                        self._conv_req_mess('Discard', self._get_card_str(hand_special_sum[min_index][0], hand_special_sum[min_index][1]), '')
                        put = self._discard_hou(hand_special_sum[min_index][0], hand_special_sum[min_index][1])
                        return put
            else:
                if hand_array_else_first != []:
...
class Fan_Fou1(MahJong_NO_State_Base):
    def __init__(self, seat, majiang):
        """每个玩家获取手牌"""
        # 存储游戏玩家所有的状态数据
        self.StateData = np.zeros(shape=(4, 7, 4, 9), dtype=np.int8)
    ...
    def del_ourself_drw(self):
        ...
        try:
            ...
            if chow_hand_card != "":
                print('fan_fou chow_hand_card != ""的情况', chow_hand_card)
                put = pair_chai(self)
                return put
            ...
            # 寻求对对胡
                ...
                # 普通胡
                    ...
                    print('fan_fou chow_hand_card == ""并且碰杠三张个数小于4的情况')
                    put = pair_chai(self)
                    return put
...
class Fan_Fou2(MahJong_NO_State_Base):
    def __init__(self, seat, majiang):
        """每个玩家获取手牌"""
        # 存储游戏玩家所有的状态数据
        self.StateData = np.zeros(shape=(4, 7, 4, 9), dtype=np.int8)
...
if __name__ == "__main__":
    ...
    def start():
        ...
        fan_fou1 = Fan_Fou1(1, majiang_split[1])
        fan_fou2 = Fan_Fou2(3, majiang_split[3])
        # robot2 = MahJong_NO_State_Base(seat=2, majiang_own=majiang_split[2])
        fan_fou_mc1 = Fan_Fou_MC1(0, majiang_split[0])
        fan_fou_mc2 = Fan_Fou_MC2(2, majiang_split[2])
        ...
        MahJong_NO_State_Base.history = []
        majiang = majiang[52:]
        # i = 0
        i = random.choice([0, 1, 2, 3])
        gamerlist = [fan_fou_mc1,fan_fou1,fan_fou_mc2,fan_fou2]
            ...
            while i < 4:
                ...
                if listen_list[i] != -1 and sum(listen_list) != -4:
                    ...
                    if i == 0 or i == 2:
                        ...
                        print('非听牌fan_fou_mc{}玩家弃牌正常打牌{}'.format(i, put))
                    else:
                        put = gamerlist[i].del_ourself_drw()
                        print('非听牌fan_fou{}玩家弃牌正常打牌{}'.format(i, put))
                    # else:
                    #     put = gamerlist[i].del_ourself_drw()
