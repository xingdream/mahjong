...
if __name__ == "__main__":
    ...
    def start():
        ...
        fan_fou1 = Fan_Fou1(0, majiang_split[0])
        fan_fou2 = Fan_Fou2(2, majiang_split[2])
        # robot2 = MahJong_NO_State_Base(seat=2, majiang_own=majiang_split[2])
        fan_fou_mc1 = Fan_Fou_MC1(1, majiang_split[1])
        fan_fou_mc2 = Fan_Fou_MC2(3, majiang_split[3])
        ...
        gamerlist = [fan_fou1,fan_fou_mc1,fan_fou2,fan_fou_mc2]
